...
public abstract class UiApp implements ApplicationListener {
	...
	public float defaultTransitionTime = .333f;
	private float transitionTimeLeft = 0f;
	...
	public void create() {
		...
		stage.setKeyboardFocus(currentScreen);
	}
	...
	public void switchScreens(BaseScreen screen) {
		transitionTimeLeft = currentScreen.transitionTime;
		nextScreen = screen;
